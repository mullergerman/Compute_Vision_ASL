...
# Debug configuration - RESET COUNTER
saved_image_count = 0
...
def process_video(ws):
    ...
    print(f"🔄 NEW CONNECTION - Reset image counter to 0")
    saved_image_count = 0  # Reset counter for new connection
    ...
    while True:
        ...
        try:
            ...
            if saved_image_count < MAX_IMAGES_TO_SAVE:
                ...
                filename = f"{DEBUG_DIR}/new_frame_{saved_image_count:03d}_{timestamp}.jpg"
                cv2.imwrite(filename, frame)
                print(f"DEBUG: ✅ Saved NEW image {filename} - Count: {saved_image_count + 1}")
                saved_image_count += 1
...
if __name__ == "__main__":
    print("🚀 Starting ASL Backend with FRESH image capture...")
